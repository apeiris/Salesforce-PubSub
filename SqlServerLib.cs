...
namespace mySalesforce {
	...
	public static class SqlServerLibExtensions {
		...
		static void dummyTestforGitHub() {
			...
			Console.WriteLine("This is a dummy test for GitHub.");
			Console.WriteLine("testing git activity");
			Console.WriteLine("testing git activity 2");
			Console.WriteLine("testing git activity 3");
			Console.WriteLine("testing git activity 4");
			Console.WriteLine("testing git activity 5");
			Console.WriteLine("testing git activity 6");
		}
		#endregion	helpers
